...
use super::{NeuralNetwork, ConstraintSystem, convolution_layer,  linear, relu_activation, sign_activation, max_pool, AccuracyParams, TensorAddress};
...
impl NeuralNetwork {
    pub fn new_lenet_unoptimized(accuracy: bool) -> NeuralNetwork {
        ...
        c.log_cons("fc1");
        let fc1_relu = relu_activation(&mut c, fc1_out, 15);
        c.log_cons("fc1_relu");
        let (fc2_out, fc2_weight, fc2_bias) = linear(&mut c, fc1_relu, 10);
        c.log_cons("fc2");
